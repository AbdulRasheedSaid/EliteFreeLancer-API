...
gigSchema.index({ title: 1 }); // Index on 'title'
gigSchema.index({ category: 1 }); // Index on 'category'


gigSchema.index({ title: 1, category: 1 }); // Optimized for queries involving both fields
